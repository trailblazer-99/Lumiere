...
public sealed partial class SettingsPage : Page
{
    ...
    private void InitializeSettingsSearchCatalog()
    {
        ...
        _allSearchItems.Add(new SettingSearchItem { Title = "Peak brightness (nits)", Description = "Set target peak brightness for HDR to SDR tone mapping", Section = "Video", Keywords = "nits, peak, luminance, monitor, brightness, hdr", TargetElement = VideoSection });
